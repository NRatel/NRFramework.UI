...
public class UIPanelHome_MyIconBase : UIWidget
{
	...
	protected TextMeshProUGUI m_Index_TextMeshProUGUI;
    ...
    protected override void OnBindCompsAndEvents() 
    {
		...
		m_Index_TextMeshProUGUI = (TextMeshProUGUI)viewBehaviour.GetComponentByIndexs(2, 0);
