...
namespace NRFramework
{
    static public class FindCompErrorCode
    {
        ...
        public const int NOT_EXIST_ANY_CHILD_WIDGET = 1004;     //View中不存在任何子Widget
        public const int WIDGET_ID_IS_NULL_OR_EMPTY = 1005;     //widgetId为null或""
        ...
        public const int VIEW_PATH_IS_NULL_OR_EMPTY = 1009;     //viewPath为null或""

        //UIManager中
        public const int NOT_EXIST_THIS_ROOT = 1010;            //UIManager中不存在此Root
