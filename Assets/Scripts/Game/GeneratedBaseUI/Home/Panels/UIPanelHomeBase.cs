...
public class UIPanelHomeBase : UIPanel
{
    ...
    {
		m_Bg_Image = (Image)viewBehaviour.GetComponentByIndexs(0, 0);
		m_Desc_TMPText = (TextMeshProUGUI)viewBehaviour.GetComponentByIndexs(1, 0);
		m_IconRoot_RectTransform = (RectTransform)viewBehaviour.GetComponentByIndexs(2, 0);
		m_BtnAddIcon_Button = (Button)viewBehaviour.GetComponentByIndexs(3, 0);
		m_BtnAddIcon_Image = (Image)viewBehaviour.GetComponentByIndexs(3, 1);
